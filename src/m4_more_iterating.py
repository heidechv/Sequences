...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [600, 1004, 20000, 5040, 867, 3306]
    threshold = 1000
    expected = 4
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 4
    actual = count_positive_sines([-5, 13, 5, 2, 3])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 25
    actual = sum_first_n([15, 10, 24, 60, 300], 2)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 30
    actual = sum_first_n([2, 4, 6, 8, 10], 5)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
